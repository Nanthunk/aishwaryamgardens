...
function Home() {
  ...
  <a
    ...
    style={{ display: "block", marginTop: "20px", color: "white", textDecoration: "underline" }}
  >
    📍 எங்கள் இடம் செல்லும் வழியை அறிய இங்கே தொடவும்
  </a>
</div>
      ...
      <div className="direction-section">
        <center>
          <h1>Directions</h1>
          <p>எங்களைச் சுற்றி உள்ள இடங்களை கண்டறிய வட்டத்தில் உள்ள <b>"N , E , S , W"</b> ஆகிய திசைகளின் எழுத்தை தொடவும்</p>
        </center>
